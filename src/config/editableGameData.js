...
export const WEAPON_BASE_STATS = {
  ...
  echo_tuning_fork: { level: 0, timer: 0.75, cooldown: 1.35, count: 1, damage: 42, range: 430, angle: Math.PI * 0.39, echoRadius: 92, echoDamage: 25, echoDuration: 0.55, resonanceDamage: 20, quality: "common", qualityMult: 1 },
