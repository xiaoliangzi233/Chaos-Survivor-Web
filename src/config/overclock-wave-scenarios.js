...
const WAVE_3_POOL = [...new Set([...WAVE_1_POOL, ...WAVE_2_POOL, "wisp", "pentastar"])];
...
export const OVERCLOCK_WAVE_SCENARIOS = [
  ...
  { wave: 13, pool: ["magnet_raider", "exploder", "mech_worm", "magma_beetle", "razorbat", "gearfiend"], spawnRate: 1.3, event: { type: "hazard_field", count: 16, kind: "gear_trap", color: "#ffd166", radius: 42, life: 999, fullWave: true, minPlayerDistance: 260, moving: true, speed: 150 } },
  ...
  { wave: 18, pool: ["gunner", "magnet_raider", "blackhole_mage", "wizard", "pentastar", "gearfiend"], spawnRate: 1.48, event: { type: "hazard_field", count: 20, kind: "gear_trap", color: "#ff4d6d", radius: 44, life: 999, fullWave: true, minPlayerDistance: 280, moving: true, speed: 310 }, effect: "overclock_pulse" },
