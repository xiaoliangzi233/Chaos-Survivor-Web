...
export const SINGULARITY_WAVE_SCENARIOS = [
  ...
  { wave: 4, pool: ["lancer", "zombie", "pentastar"], spawnRate: 1.12, event: { type: "sweeping_laser_maze", count: 1, width: 34, damage: 24, speed: 105, life: 999, fullWave: true, endSafetyPadding: 20 }, effect: "laser_disaster" },
