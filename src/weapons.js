...
export const UPGRADE_DEFS = [
  ...
  { id: "drone", icon: WEAPON_INFO.drone.icon, name: "无人机编队", desc: "获得一架新的无人机，提高弹幕伤害和电池容量。", apply: () => { if (!activateWeapon("drone")) return; const w = state.weapons.drone; w.bulletDamage += 3; w.batteryMax += 12; w.fireCooldown = Math.max(0.24, w.fireCooldown * 0.92); } },
